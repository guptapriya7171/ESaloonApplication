<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="inventory.aspx.cs" Inherits="WebApplication1.inventory" %>
       ...
       <div class="col-md-5">
                  ...
                  <div class="card-body">
                   ...
                   <div class="col" style="text-align:center">
                     ...
                     <h4>Client Inventory Details</h4>
                     </div>
                  </div>
                  ...
                  <div class="row">
                   ...
                   <img width="100" src="Imgs/yourOrder.png"/> 
          ...
          <div class="row">
               ...
               <div class="col-12">
                    <label>Full Address</label>
                       <div class="form-group">
                       <asp:TextBox  class="form-control" ID="TextBox14" runat="server" placeholder="Full Address" 
   ...
   <div class="row">
          ...
          <div class="col-md-7">
              ...
              <div class="row">
                 ...
                 <div class="row">
                     <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:eSalonDBConnectionString %>" SelectCommand="SELECT * FROM [Inventory_detail]"></asp:SqlDataSource>
                   <div class="col">
                       <asp:GridView class="table table-striped table-bordered" ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" ForeColor="Black">
                           <Columns>
