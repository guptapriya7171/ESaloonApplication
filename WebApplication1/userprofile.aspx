    ...
    <div class="container-fluid">
       ...
       <div class="col-md-5">
            ...
            <div class="card-body">
              ...
              <div class="row">
                   <div class="col">
                     <center>
                     <h4>Your Profile</h4>
                         <h6>Account Status - <span class="badge bg-primary">Active</span></h6>
                     </center> 
                   </div></div>
           ...
           <div class="col-md-4">
              ...
              <div class="row">
               <div class="col-8 mx-auto">
                 <center>
                <div class="form-group">
                  <a href="usersignup.aspx"><input class="btn btn-success w-100 btn-block  btn-lg " id="Button2" type="button" value="Update" /></a>
                   </div></center>
                  </div></div>
          ...
          <div class="card-body">
           ...
           <div class="col">
              <center>
             <img width="100px" src="Imgs/yourOrder.png" />
             </center> 
           </div>
           </div>
                  ...
                  <div class="row">
                   <div class="col">
                     ...
                     <h4>Your Orders List</h4>
                      <span class="badge bg-primary">Info About Last Orders</span>
                     </center> 
                   </div></div>  
